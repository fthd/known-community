$(document).ready(function() {
	$(".slowshow").click(function(event) {
		document.location.href = known.realpath + "/knowledge/pCategoryId/" + $(this).attr("pCategoryId");
	});
	$(".slowshow i").click(function(event) {
	...
	$("#publicKnowledgeBtn").click(function(event) {
		...
		document.location.href = known.realpath + "/knowledge/prePublicKnowledge";
	});
