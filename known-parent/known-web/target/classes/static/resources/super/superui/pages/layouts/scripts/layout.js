...
var Layout = function () {
    ...
    var layoutImgPath = 'pages/layouts/img/';

    var layoutCssPath = 'pages/layouts/css/';
    ...
    var handleIframeContentHeight=function() {
        //var content = $('.page-content');
        //var sidebar = $('.page-sidebar');
        //var mainWidth = content.width() - sidebar.outerWidth();
        $(".tab_iframe").attr("style", 'width:100%');
    }
    ...
    return {
        ...
        initContent: function() {
            ...
            App.addResizeHandler(handleIframeContentHeight);
        },
        ...
        fixContentWidth:function() {
            handleIframeContentHeight();
        },
        ...
        getLayoutImgPath: function () {
            return App.getbasePath() + layoutImgPath;
        },

        getLayoutCssPath: function () {
            return App.getbasePath() + layoutCssPath;
        }
    };
