...
public class CollectionServiceImpl implements CollectionService {
    ...
    public void addCollection(Collection collection) throws BussinessException {
        ...
        Collection c = findCollectionByKey(collectionQuery);
        if (c != null) {
    ...
    public Collection findCollectionByKey(CollectionQuery collectionQuery) {
        List<Collection> collectionList = collectionMapper.selectList(collectionQuery);
    ...
    public PageResult<Collection> findCollectionByPage(
        ...
        int count = collectionMapper.selectCount(collectionQuery);
        ...
        List<Collection> list = collectionMapper.selectList(collectionQuery);
