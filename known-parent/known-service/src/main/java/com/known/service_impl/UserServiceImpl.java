...
import com.known.common.utils.MailUtils;
...
public class UserServiceImpl implements UserService {
	...
	public void copyUserIcon(User user,String source, String dest,String userId) {
		File sourceFile = new File(ABSOLUTE_PATH + "/resources/images/" + source);
		File destFile = new File(ABSOLUTE_PATH + "/resources/images/" + dest);
		try {
