...
CREATE TABLE `known_ask`  (
  ...
  `p_category_id` int(11) NULL DEFAULT NULL COMMENT '组ID',
  ...
  `best_answer_id` int(11) NULL DEFAULT NULL COMMENT '最佳回复id',
  `best_answer_user_id` int(11) NULL DEFAULT NULL COMMENT '最佳答案作者ID',
...
CREATE TABLE `known_attachment`  (
  ...
  `download_mark` int(11) NULL DEFAULT NULL COMMENT '下载所需积分',
...
CREATE TABLE `known_category`  (
  ...
  `pid` int(11) NULL DEFAULT 0 COMMENT '父节点ID',
  ...
  `rank` int(11) NULL DEFAULT NULL COMMENT '分类排名',
...
CREATE TABLE `known_collection`  (
  ...
  `article_user_id` int(11) NULL DEFAULT NULL COMMENT '文章作者',
...
CREATE TABLE `known_message`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `received_user_id` int(11) NULL DEFAULT NULL COMMENT '接收人ID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Records of known_shuoshuo
-- ----------------------------
INSERT INTO `known_shuoshuo` VALUES (3433, 10086, '/resources/images/default_usericon/5.jpg', 'will', '', '', NULL, '晚上心情才是最好的[蜡烛]', '2019-05-24 16:14:31', 0, 0);
...
CREATE TABLE `known_shuoshuo_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `shuoshuo_id` int(11) NULL DEFAULT NULL COMMENT '说说ID',
...
-- ----------------------------
-- Records of known_sign_in
-- ----------------------------
INSERT INTO `known_sign_in` VALUES (10086, '/resources/images/default_usericon/5.jpg', 'will', '2019-05-24', '2019-05-24 14:44:20');
INSERT INTO `known_sign_in` VALUES (10086, '/resources/images/default_usericon/5.jpg', 'will', '2019-05-26', '2019-05-26 16:32:32');
...
-- ----------------------------
-- Records of known_topic
-- ----------------------------
INSERT INTO `known_topic` VALUES (1, 0, 13, 14, 'Java集合中List,Set以及Map', '&lt;p&gt;List&nbsp;,&nbsp;Set,&nbsp;Map都是接口，前两个继承至collection接口，Map为独立接口&lt;/p&gt;&lt;p&gt;Set下有HashSet，LinkedHashSet，TreeSet&lt;/p&gt;&lt;p&gt;List下有ArrayList，Vector，LinkedList&lt;/p&gt;&lt;p&gt;Map下有Hashtable，LinkedHashMap，HashMap，TreeMap&lt;/p&gt;&lt;p&gt;collection接口下还有个Queue接口，有PriorityQueue类&lt;/p&gt;', 'List , Set, Map都是接口，前两个继承至collection接口，Map为独立接口Set下有HashSet，LinkedHashSet，TreeSetList下有ArrayList，Vector，LinkedListMap下有Hashtable，LinkedHashMap，HashMap，TreeMapcollection接口下还有个Queue接口，有PriorityQueue类', 10086, '/resources/images/default_usericon/5.jpg', 'will', '2019-05-26 16:43:08', '2019-05-26 16:43:08', 0, 0, 0, 0, 0, 0, '', '');
INSERT INTO `known_topic` VALUES (2, 0, 13, 14, 'Java多线程', '&lt;p&gt;Java线程有四种创建方式？&lt;br/&gt;&lt;/p&gt;', 'Java线程有四种创建方式？', 10086, '/resources/images/default_usericon/5.jpg', 'will', '2019-05-26 17:37:20', '2019-05-26 17:37:20', 0, NULL, 0, 0, NULL, NULL, '', '');
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26270 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_res`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `pid` int(11) NULL DEFAULT NULL COMMENT '父节点ID',
  `name` varchar(111) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `sys_role_res`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `role_id` int(11) NULL DEFAULT NULL COMMENT '权限表ID',
  `res_id` int(11) NULL DEFAULT NULL COMMENT '系统权限详情表ID',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` int(11) NULL DEFAULT NULL COMMENT '系统权限表ID',
  PRIMARY KEY (`id`) USING BTREE,
